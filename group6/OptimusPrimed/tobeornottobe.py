...
SAVE_FOLDER = 'C:/Users/stimuser/Desktop/CognNeuroSci-Undervisning/2022/group6/tobe_data'  # Log is saved to this folder. The folder is created if it does not exist.
...
dur_prime=int(0.034*FRAME_RATE) # duration in seconds multiplied by 60 Hz and made into integer
...
dur_task=int(3.0*FRAME_RATE) # duration in seconds multiplied by 60 Hz and made into integer
...
def circle_frame(spot, window): 
    if spot == 1:
        ...
        black_frame = visual.Rect(window,width=29.0, height=16.2, units='deg', lineWidth=1.5, lineColor=None, lineColorSpace=None, fillColor='Gray', fillColorSpace=None, pos=(0, 0))
...
introText1=[u'In this experiment you will solve a simple task of matching the colour of the frame with the correct circle',# some blanks here to create line shifts
            ...
            u'Press the "A" key with your left INDEX finger if it is the left circle that matches the frame of the color.',
            u'',
